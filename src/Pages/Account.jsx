...
import { User, LogOut, Loader2, History } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <Tabs defaultValue="profile" className="space-y-10 pb-9">
          ...
          <TabsContent value="profile" className="space-8 mt-20">
            <Card>
              <CardHeader>
          ...
          <TabsContent value="orders" className="space-y-6 mt-20">
          ...
          <TabsContent value="payments" className="space-y-6 mt-20">
            <Card>
              <CardHeader>
          ...
          <TabsContent value="settings" className="space-y-6 mt-20">
            <Card>
              <CardHeader>
